...
if (!window.API_ENDPOINTS) {
    console.error('Missing API config. Please include assets/js/api-config.js before config-nhanvien.js');
}
...
const API_BASE_STAFF = window.API_ENDPOINTS?.staff || `${FALLBACK_API_ROOT}/staff`;
const API_BASE_AUTH = window.API_ENDPOINTS?.auth || `${FALLBACK_API_ROOT}/auth`;

// Component Paths (relative to staff pages)
...
console.log('%c🏥 Eden Health - Staff Panel', 'color: #4A90E2; font-size: 16px; font-weight: bold;');
